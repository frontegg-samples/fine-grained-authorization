...
export class PolicyApis {
	...
	public async createSubject(tenantId: string, subject: Record<string, unknown>): Promise<IdResponse> {
		// TODO create openapi client for this
	...
	public async createPolicy(tenantId: string, policy: Record<string, unknown>): Promise<IdResponse> {
		// TODO create openapi client for this
		const res: AxiosResponse<IdResponse> = await axios.post(
	...
	public async setMainPolicy(tenantId: string, policyId: string, main: boolean = true): Promise<void> {
		// TODO create openapi client for this
	...
	public async createRule(tenantId: string, policyId: string, rule: Record<string, unknown>): Promise<IdResponse> {
		// TODO create openapi client for this
		const res: AxiosResponse<IdResponse> = await axios.post(
